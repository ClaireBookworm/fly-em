  ...
  return (
    <div className="essay essay-neuron em-lesson">
      ...
      <main>
        ...
        >
          <LessonCopy as="h2" copyId="lesson-1" id="em-roadmap-title">
            What are we trying to reproduce?
          </LessonCopy>
          <LessonCopy as="p" copyId="lesson-2">
            Here, emulating means building a model that predicts a chosen
            response to an input. We choose what to keep, supply parameters, run
            the equations through time, and test the result against biology. A
            useful model might predict when a neuron fires without reproducing
            every detail inside it.
          </LessonCopy>
          <LessonCopy as="p" copyId="lesson-3">
        ...
        <section className="essay-chapter" id="one-cell">
          <div className="essay-copy">
            <LessonCopy as="h2" copyId="lesson-4">
              First, a membrane that remembers—and leaks.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-5">
              The membrane separates the cell’s inside from its outside. Voltage
              is the electrical potential difference across it; −65 mV means the
              inside is 65 millivolts below the outside reference. Capacitance
              lets separated charge build up, while open channels let current
              pass.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-6">
          ...
          <div className="essay-copy em-section-after">
            <LessonCopy as="h3" copyId="lesson-7">
              Where did the spike come from?
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-8">
            ...
            <LessonCopy as="p" copyId="lesson-9">
              <a
        ...
        <section className="essay-chapter" id="channels">
          ...
          <HHExperiment />
          <div className="essay-copy em-section-after">
            <LessonCopy as="h3" copyId="lesson-10">
              What does the extra complexity buy us?
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-11">
          ...
          <div className="em-tradeoff-table">
            ...
            <LessonCopy as="p" copyId="lesson-12" className="essay-fine">
            ...
            <details className="essay-method-note">
              ...
              <LessonCopy as="p" copyId="lesson-13">
                ...
                keeps two models interactive so their assumptions stay visible.{' '}
                <a
        ...
        <section className="essay-chapter" id="comparison">
          <div className="essay-copy">
            <LessonCopy as="h2" copyId="lesson-14">
              Now give the model the real input.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-15">
          ...
          <div className="essay-copy em-section-after">
            <LessonCopy as="h3" copyId="lesson-16">
              A mismatch is a question to investigate.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-17">
            ...
            <LessonCopy as="p" copyId="lesson-18">
          ...
          <div className="essay-wide essay-network-experiment">
            ...
            <div className="essay-network-controls">
              ...
              {motif === 'modules' ? (
                ...
                <LessonCopy as="p" copyId="lesson-20" className="essay-fine">
            ...
            <LessonCopy as="p" copyId="lesson-22" className="essay-fine">
              ...
              µA/cm² from 20–120 ms. Coupling scales assumed conductances, with
              a 1 ms delay and decay times of 5 ms for excitation / 10 ms for
              inhibition. The network has its own default membrane parameters,
              independent of the sodium experiment above.
            </LessonCopy>
            <a href="/lab#circuits" className="essay-text-link">
        ...
        <section className="essay-chapter em-takeaway">
          <div className="essay-copy">
            <LessonCopy as="h2" copyId="lesson-23">
              One neuron is already a set of choices.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-24">
              We chose a state to track, rules for updating it, parameters, an
              input, and a way to compare the output with a measurement. LIF and
              HH make different commitments. Which is useful depends on what we
              want to predict.
            </LessonCopy>
            <LessonCopy as="p" copyId="lesson-25">
              A circuit adds synapses, connection strengths and delays. A
              whole-brain emulation repeats these choices across many cells—and
              must still earn its claims against biological data. Anatomy
              supplies part of the model, not all of it.
            </LessonCopy>
          </div>
        </section>
        <StoryNext
        ...
        <div className="essay-source-note">
          ...
          <a href="/lab">Full equations & parameter notebook ↗</a>
        </div>
      </main>
      <StoryFooter />
    </div>
