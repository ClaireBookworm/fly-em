...
export default function NeuronStory() {
  ...
  return (
    <div className="essay essay-neuron em-lesson">
      ...
      <main>
        <section className="essay-opening essay-neuron-opening">
          <span className="essay-kicker">
            Emulating a brain · start with one neuron
          </span>
          <h1>What does it take to emulate a neuron?</h1>
          <p>
            Start with one cell’s recorded response. Build a model, give it the
            same input, and see what it gets right.
          </p>
        </section>
        ...
        >
          <h2 id="em-roadmap-title">What are we trying to reproduce?</h2>
          <p>
        ...
        <section className="essay-chapter" id="one-cell">
          <div className="essay-copy">
            <h2>First, a membrane that remembers—and leaks.</h2>
            <p>
          ...
          <div className="essay-copy em-section-after">
            <h3>Where did the spike come from?</h3>
            <p>
        ...
        <section className="essay-chapter" id="channels">
          ...
          <HHExperiment />
          <div className="essay-copy em-section-after">
            <h3>What does the extra complexity buy us?</h3>
            <p>
        ...
        <section className="essay-chapter" id="comparison">
          <div className="essay-copy">
            <h2>Now give the model the real input.</h2>
            <p>
          ...
          <div className="essay-copy em-section-after">
            <h3>A mismatch is a question to investigate.</h3>
            <p>
        ...
        <section className="essay-chapter em-takeaway">
          <div className="essay-copy">
            <h2>One neuron is already a set of choices.</h2>
            <p>
