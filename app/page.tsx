...
type Recordings = Record<CircuitKey, Recording>;
...
function Evidence({ data, circuit }: { data: Recording; circuit: CircuitKey }) {
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const t = setInterval(() => setCursor((c) => (c + 4) % 601), 40);
      ...
      <div className="workspace">
        <aside className="rail">
          <div className="rail-intro">
            <span className="eyebrow">A circuit at a time</span>
            <h1>
              From wiring
              <br />
              to dynamics.
          ...
          <div className="circuit-menu" aria-label="Choose circuit">
            {(Object.keys(circuits) as CircuitKey[]).map((k) => (
              <button
                ...
                onClick={() => choose(k)}
                aria-pressed={key === k}
                style={{ '--choice': circuits[k].color } as React.CSSProperties}
              >
          ...
          {loadError ? (
            ...
            <>
              ...
              <div className="lab-heading">
                <div>
                  <span className="eyebrow">The experiment bench</span>
                  <h2>{meta.question}</h2>
                </div>
                <button
              ...
              <div className="lab-grid">
                <section className="simulation-card">
                  <div className="section-heading">
                    <div>
                      ...
                      <h3>One graph, three dynamics</h3>
                    </div>
                  ...
                  {simError ? (
                    ...
                    <div className={busy ? 'calculating' : ''}>
                      ...
                      {model === 'graded' ? (
                        ...
                        <Raster result={result} onSelect={setSelected} />
                      )}
                    </div>
                  ) : (
                  ...
                  <p className="stimulus-note">{meta.stimulus}</p>
                  <button
                ...
                <section className="evidence-card">
                  {recordings && (
                    <Evidence key={key} data={recordings[key]} circuit={key} />
                  )}
                </section>
              </div>
              <Tabs
